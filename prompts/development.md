...
**Graduation-discipline rejection-basis bounded scope (cites DV-S190-2, EF-S196-2, DV-S196-1, FR-S196-15, OI-S196-7).** DV-S190-2 graduation-discipline named the substrate-receipt-gate pattern: defer mechanism-addition to a watch-FR with a graduation-trigger when (a) false-positive cost is measurable in advance, and (b) the proposed mechanism controls admission of uncertain external material at a transaction boundary. EF-S196-2 (S196 bounded-scope reframe) bounds this scope: graduation-discipline does NOT authorize watch-FR deferral for *engine primitives* evidenced by completed multi-session application arcs, operator-curated synthesis, or direct failure-mode recurrence. Future sessions citing `DV-S190-2` as the rejection-basis cite for an alternative MUST also cite `EF-S196-2` as the bounding interpretation; the chain-walk graph at decision-record submit (T-32) surfaces both anchors so an audit-reader sees the bound. Recurrence of unsurfaced graduation-discipline-as-deferral-basis (citing DV-S190-2 alone for an engine-primitive candidate evidenced by a completed arc) is a calibration-EF candidate at the next session-open per §8.5 audit-step retrospective + §8.6 prospective-scoping (caller-implications pattern). The bound applies symmetrically: when the candidate is a substrate-receipt gate at a transaction boundary with measurable false-positive cost (e.g., DV-S190-2's own substrate-receipt-FR-E case), graduation-discipline DOES authorize watch-FR deferral; cite DV-S190-2 alone, EF-S196-2 does not bind."
