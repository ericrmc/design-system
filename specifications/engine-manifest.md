...
status: active
created: 2026-04-27
updated-by-session: 088
supersedes: engine-manifest v21 (engine-v21); per 088 D-1 (issues substrate table replaces markdown OIs); v21 per 087 D-1 (migration 008 widens T-06); v20 per 084 D-2 (Path A substrate-only writes); v19 per 083 D-2 (coding review loop); v18 per 082 D-1 (migration 002 + migrate runner); v17 per 078 D-7 + D-11
---
