...
**`engine-v5`** (established Session 028 per D-096).

Subsequent engine versions (`engine-v6`, `engine-v7`, ...) increment per the versioning discipline in §5. The current engine version is always named by this §2.

### 3. Engine-definition files at `engine-v5`
