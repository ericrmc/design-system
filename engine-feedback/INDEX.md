...
- **Triaged** (triage-record exists, awaiting resolution): 3
- **Resolved** (triage-record + resolution pointer): 1
...
|----|------------------|----------------|--------|----------|--------|----------------|----------------|
| [EF-047-brief-slot-template-hidden-arc-leakage](inbox/EF-047-brief-slot-template-hidden-arc-leakage.md) ([triage](triage/EF-047-brief-slot-template-hidden-arc-leakage.md)) | selvedge-self-development | 047 | engine | friction | triaged — adoption bundled S050 MAD per S049 D-161 defer (was S049; scope revision D-157) | 048 | options (a)/(b)/both under deliberation at S050 |
| [EF-047-session-input-files-redundant-with-verbatim-capture](inbox/EF-047-session-input-files-redundant-with-verbatim-capture.md) ([triage](triage/EF-047-session-input-files-redundant-with-verbatim-capture.md)) | selvedge-self-development | 047 | methodology | observation | triaged — practice-level adopted; spec-level minor documentary bundled S050 MAD per S049 D-161 defer | 048 | paragraph amendment to prompts/application.md §Engine-feedback pathway or workspace-structure.md §engine-feedback |
...
| [EF-047-retrieval-discipline-and-text-system-scaling-ceiling](inbox/EF-047-retrieval-discipline-and-text-system-scaling-ceiling.md) ([triage](triage/EF-047-retrieval-discipline-and-text-system-scaling-ceiling.md)) | selvedge-self-development | 047 | methodology | friction | triaged — rescheduled S050 MAD per S049 D-157/D-160 operator scope revision (S049 produced synthesis + design-space + S050 8-question agenda) | 048 | design-space at provenance/049-session/design-space.md; Option A SQLite FTS5 recommended; Option B DuckDB+FTS strongest competitor; 6 alternatives rejected with rationale; OI-019 sub-question (f) cross-referenced |
