...
The methodology kernel in `specifications/methodology.md` is the same in both modes. Workspace structure in `specifications/workspace.md` applies to both modes.
